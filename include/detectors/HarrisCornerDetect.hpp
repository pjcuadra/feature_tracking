...
#define HARRISCORNERDETECT_OPTIONS                                             \
...
protected:
  virtual void _runDetect() {
    cornerHarris(this->inputImage, this->outputHarris, this->blockSize,
  ...
  virtual void updateOutputImage() {
    ...
    /// Normalizing
    normalize(outputHarris, outputHarrisNorm, 0, 255, NORM_MINMAX, CV_32FC1,
              Mat());
    convertScaleAbs(outputHarrisNorm, outputHarrisNormScaled);
